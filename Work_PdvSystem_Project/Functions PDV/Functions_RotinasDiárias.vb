...
Public Class Functions_RotinasDiárias
    ...
    Private Sub KeyNuberFunction_KeyDown(sender As Object, e As KeyEventArgs) Handles TitleDialog_Label.KeyDown
        Select Case e.KeyCode
            ...
            Case Keys.NumPad3
                e.SuppressKeyPress = True
                EnterOperatorCodeDialog.Text = "Entrada de Operador(a)"
                EnterOperatorCodeDialog.ShowDialog()
